...
#     }
#
#     if word_hash[:score] > max_score
#       winning_word_and_score[:winning_word] = word_hash[:word]
#       winning_word_and_score[:winning_score] = word_hash[:score]
...
#   end
#
# puts highest_score_from(["happy", "gigantic"]).class
